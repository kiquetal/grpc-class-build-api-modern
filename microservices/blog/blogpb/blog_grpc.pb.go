...
type BlogServiceClient interface {
	...
	ReadBlog(ctx context.Context, in *ReadBlogRequest, opts ...grpc.CallOption) (*Blog, error)
	UpdateBlog(ctx context.Context, in *UpdateBlogRequest, opts ...grpc.CallOption) (*UpdateBlogResponse, error)
	DeleteBlog(ctx context.Context, in *ReadBlogRequest, opts ...grpc.CallOption) (*DeleteBlogResponse, error)
}
...
func (c *blogServiceClient) ReadBlog(ctx context.Context, in *ReadBlogRequest, opts ...grpc.CallOption) (*Blog, error) {
	out := new(Blog)
...
func (c *blogServiceClient) DeleteBlog(ctx context.Context, in *ReadBlogRequest, opts ...grpc.CallOption) (*DeleteBlogResponse, error) {
...
type BlogServiceServer interface {
	...
	ReadBlog(context.Context, *ReadBlogRequest) (*Blog, error)
	UpdateBlog(context.Context, *UpdateBlogRequest) (*UpdateBlogResponse, error)
	DeleteBlog(context.Context, *ReadBlogRequest) (*DeleteBlogResponse, error)
...
func (UnimplementedBlogServiceServer) ReadBlog(context.Context, *ReadBlogRequest) (*Blog, error) {
...
func (UnimplementedBlogServiceServer) DeleteBlog(context.Context, *ReadBlogRequest) (*DeleteBlogResponse, error) {
...
func _BlogService_DeleteBlog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlogServiceServer).DeleteBlog(ctx, req.(*ReadBlogRequest))
	}
	return interceptor(ctx, in, info, handler)
}
